...
namespace Services.Contracts
{
    public interface IStockService
    {
        ...
        Task<IEnumerable<StockResponse>> GetStocksByIsDeletedStatusAsync(bool isDeleted, bool trackChanges);
        Task<IEnumerable<StockResponse>> GetAllStocksWithDeletedStatusAsync(bool trackChanges);
